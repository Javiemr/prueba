   ...
   <!-- Imagen de fondo -->
    ...
    <class class="navbar navbar-light py-4 sticky-top" style="z-index: 99; background-color: rgb(246, 243, 243); box-shadow: 0px 0px 7px 0px;">
        ...
        <% }%>
            ...
            <a href="#" class="fadeout" style="text-decoration: none; color:  rgb(25, 111, 223); position: relative;"><h2><b>Bienvenido!</b></h2></a>       
            <div class="dropdown">
...
<div class="container">
    <h1><br><br></h1>
        <div class=""> 
            <a href="modificarDinos.jsp"> <img src="imagen/listadodino.png" alt="imagenlista"> </a>
        </div>
    <div class="">
        <a href="zonasdino.jsp"> <img src="imagen/zonadino.png" alt="imagenlista"> </a>
        </div>
